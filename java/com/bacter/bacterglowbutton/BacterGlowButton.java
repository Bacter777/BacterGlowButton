package com.bacter.bacterglowbutton;
...
public class BacterGlowButton extends AppCompatButton implements View.OnTouchListener
{
    ...
    public BacterGlowButton(final Context context)
    {
        super(context);
    ...
    public BacterGlowButton(final Context context, final AttributeSet attrs)
    {
        super(context, attrs);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
    ...
    public BacterGlowButton(final Context context, final AttributeSet attrs, int defStyleAttr)
    {
    ...
    public boolean onTouch(final View v, final MotionEvent motionEvent)
    {
        switch (motionEvent.getAction())
        {
            case MotionEvent.ACTION_DOWN:
                setBackground(getBackgroundWithGlow(this, mBackgroundColor, mGlowColor, mCornerRadius, mUnpressedGlowSize, mPressedGlowSize));
                break;

            case MotionEvent.ACTION_UP:
                setBackground(getBackgroundWithGlow(this, mBackgroundColor, mGlowColor, mCornerRadius, mUnpressedGlowSize, mUnpressedGlowSize));
                break;
        }
        return false;
    }
    ...
    public static Drawable getBackgroundWithGlow(View view, int backgroundColor, int glowColor, int cornerRadius, int unPressedGlowSize, int pressedGlowSize)
    {
